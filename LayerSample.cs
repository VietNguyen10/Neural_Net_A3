...
namespace NeuralNet
{
    internal class LayerSample
    {
        ...
        // Create the layer
        public LayerSample(int numNodesIn, int numNodesOut, System.Random rng)
        {
        ...
        public void InitializeRandomWeights(System.Random rng)
        {
            ...
            double RandomInNormalDistribution(System.Random random, double mean, double standardDeviation)
            {
